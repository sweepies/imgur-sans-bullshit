<script lang="ts">
	...
	const pageTitle = $derived(album?.title || (images.length === 1 ? images[0]?.title : null) || `Image ${$page.params.id}`);
	...
	<div class="container mx-auto px-4 py-8">
		<div class="max-w-6xl mx-auto">
			...
			<div class="mt-8 flex flex-wrap gap-4 justify-center">
				...
				<ViewOnImgurButton id={$page.params.id || ''} type={album ? 'album' : 'image'}>
					View on Imgur
				</ViewOnImgurButton>
			</div>
		</div>
